\acknowledgments{% \vskip2pc
  ...
  At the time of writing, Chapter \ref{ch:JHE} had been published as \textit{Chen et al.} [2017] in the \textit{Journal of Hydrologic Engineering}, and Chapter \ref{ch:EF} had been published as \textit{Chen and Hossain} [2016] in the \textit{Earth's Future}. I would like to thank the \textit{Journal of Hydrologic Engineering}, published by the American Society of Civil Engineers, and the \textit{Earth's Future}, published by the American Geophysical Union, for granting the rights to include their articles as part of this dissertation.
  % \par}
}